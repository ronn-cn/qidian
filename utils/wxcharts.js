...
function measureText(text) {
    ...
    // console.log("AA",ctx.measureText(text));
    ...
    series.forEach(function (eachSeries, seriesIndex) {
        ...
        points.forEach(function (item, index) {
            if (item !== null) {
                ...
                // console.log("opts.height ", opts.height, "|item.y", item.y, 
                // "|config.xAxisHeight", config.xAxisHeight,
                // "|config.legendHeight",  config.legendHeight,
                // )
            }
        });
        context.closePath();
...
function drawYAxisGrid(opts, config, context) {
    if (!opts.yAxis.disableGrid) return;
